...
<head>
    ...
    <title>Liste des Candidats - {{ $filiere->nom_filiere ?? 'Filière' }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h2>LISTE DES CANDIDATS - {{ strtoupper($filiere->nom_filiere ?? 'FILIÈRE') }}</h2>
    </div>

    <div class="info-box">
        <p><strong>Filière:</strong> {{ $filiere->nom_filiere ?? 'N/A' }}</p>
        <p><strong>Département:</strong> {{ $filiere->departement->nom_departement ?? 'N/A' }}</p>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="9" style="text-align: center; padding: 20px;">
                    Aucun candidat trouvé pour cette filière
                </td>
            </tr>
            @endforelse
        </tbody>
